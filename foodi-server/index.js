...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@barleybites.cbzpnru.mongodb.net/?retryWrites=true&w=majority&appName=BarleyBites
    `
  )
...
const adminStats =  require('./api/routes/adminStats');
 ...
 const deliveryBoyRoutes = require("./api/routes/deliveryBoyRoutes");
